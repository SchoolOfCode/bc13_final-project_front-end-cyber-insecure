...
export default function PortfolioForm() {
    ...
    return (
        <div className='portfolio-form-container'>
            <p className='portfolio-form-p'>Send us links to your porfolio and GitHub pages! If the deVault team like what they see, 
            your work may feature on the site. </p>
            <form className='portfolio-form' onSubmit={handleSubmit(onSubmit)}>
                ...
                ></input>
                {errors.github_link &&
                    errors.github_link.type === "required" && (
                        <p className="error">GitHub link must not be blank</p>
                    )}
                {errors.github_link &&
                    errors.github_link.type === "minLength" && (
                        <p className="error">
                            GitHub link must have at least 5 characters
                        </p>
                    )}
                ...
                <button id='portfolio-button' type="submit"> Submit </button>
            </form>
        </div>
    )
}
