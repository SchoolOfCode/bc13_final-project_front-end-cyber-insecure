...
export default function InterviewForm() {
    ...
    const onSubmit = (data) => {
        ...
        reset();
        alert("Your interview question and answer have been submitted successfully.")
    };
    ...
    return (
        <div className='interview-form-container'>
            <p className='interview-form-p'>Do you have an interview question and example answer that other users can benefit from? If so, send it in for the deVault team to review.  </p>
            <form className='interview-form' onSubmit={handleSubmit(onSubmit)}>
                ...
                <button id='interview-button' type="submit"> Submit </button>
            </form>
        </div>
    )
}
