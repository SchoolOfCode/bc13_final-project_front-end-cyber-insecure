export const KnowledgeBank =   [
    {
        "title": "Array",
        "definition": "An array is a collection of elements of the same type placed in contiguous memory locations that can be individually referenced by using an index to a unique identifier. Five values of type int can be declared as an array without having to declare five different variables (each with its own identifier).",
        "image": "https://i.redd.it/s8ev4pw1p4a61.jpg",
        "article_link_one": "https://www.w3schools.com/js/js_arrays.asp",
        "article_link_two": "https://www.w3schools.com/js/js_arrays.asp",
        "video_link": "https://www.youtube.com/watch?v=R8rmfD9Y5-c"
    },
    {
        "title": "Arrow function",
        "definition": "An arrow function expression is a compact alternative to a traditional function expression, with some semantic differences and deliberate limitations in usage: Arrow functions don't have their own bindings to this , arguments , or super , and should not be used as methods",
        "image": "https://miro.medium.com/max/1400/1*_IejCVtnJg24RDNQC9xftg.png",
        "article_link_one": "https://www.w3schools.com/js/js_arrow_function.asp",
        "article_link_two": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions",
        "video_link": "https://www.youtube.com/watch?v=h33Srr5J9nY"
    },
    {
    ...
    },
    {
        ...
        "article_link_one": "https://www.w3schools.com/js/js_htmldom.asp",
        "article_link_two": "https://en.wikipedia.org/wiki/Document_Object_Model",
        "video_link": "https://www.youtube.com/watch?v=ipkjfvl40s0"
    },
    {
    ...
    },
    {
        ...
        "definition": "An event listener is a procedure in JavaScript that waits for an event to occur. The simple image of an event is a user clicking the mouse or pressing a key on the keyboard.",
        "image": "https://bootcamp.burlingtoncodeacademy.com/images/event-listener.png",
        "article_link_one": "https://www.w3schools.com/js/js_htmldom_eventlistener.asp",
        "article_link_two": "https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener",
        "video_link": "https://www.youtube.com/watch?v=XF1_MlZ5l6M"
    },
    {
        "title": "For loops",
        "definition": "A 'For' Loop is used to repeat a specific block of code a known number of times. For example, if we want to check the grade of every student in the class, we loop from 1 to that number. When the number of times is not known before hand, we use a 'While' loop.",
        "image": "https://miro.medium.com/max/1400/1*Wal8vgWVHiYnM0IrnK0p3w.jpeg",
        "article_link_one": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for",
        "article_link_two": "https://www.w3schools.com/js/js_loop_for.asp",
        "video_link": "https://www.youtube.com/watch?v=x7Xzvm0iLCI"
    },
    {
        "title": "Function",
    ...
    },
    {
        ...
        "image": "https://www.tutorialstonight.com/assets/js/javascript-object.webp",
        "article_link_one": "https://www.w3schools.com/js/js_object_definition.asp",
        "article_link_two": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object",
        "video_link": "https://www.youtube.com/watch?v=BRSg22VacUA"
    },
    {
        "title": "React props",
        "definition": "In React, the term props stands for properties, which refers to the properties of an object. This is because all elements created in React are JavaScript objects. As a result, passing data into a component is done by creating properties and values for the object.",
        "image": "https://dmitripavlutin.com/react-props/cover.png",
        "article_link_one": "https://reactjs.org/docs/components-and-props.html",
        "article_link_two": "https://www.w3schools.com/react/react_props.asp",
        "video_link": "https://www.youtube.com/watch?v=PHaECbrKgs0"
    },
    {
