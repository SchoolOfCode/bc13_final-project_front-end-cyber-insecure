      ...
      <div className="about-us-container">
        ...
        <div className="all-of-us">
          <div className="developer">
            <img className="dev-img" src={calla} alt="" />
            <p>Calla</p>
          ...
          <div className="developer">
            <img className="dev-img" src={constantin} alt=""/>
            <p>Constantin</p>
            <div className="developer-shortcuts">
              <SocialIcon
                className="icon"
          ...
          <div className="developer">
            <img className="dev-img" src={barbara} alt=""/>
            <p>Barbara</p>
            <div className="developer-shortcuts">
              <SocialIcon
                className="icon"
          ...
          <div className="developer">
            <img className="dev-img" src={miko2} alt=""/>
            <p>MiKo</p>
            <div className="developer-shortcuts">
              <SocialIcon
                className="icon"
          ...
          <div className="developer">
            <img className="dev-img" src={taylor2} alt=""/>
            <p>Taylor</p>
            <div className="developer-shortcuts">
              <SocialIcon
                className="icon"
